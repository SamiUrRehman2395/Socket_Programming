...
public class Server implements Runnable {
    ...
    private void preAddContacts() {
        contacts.add(new Contact("1", "Eman", "03039812367"));
            ...
            new Thread(() -> {
                try {
                    ...
                    while ((inputLine = in.readLine()) != null) {
                        ...
                        Sms receivedMessage = new Sms(inputLine, "Client"); // Track as sent by "Client"
                        Contact contact = findContactById("1"); // Assuming a single client
